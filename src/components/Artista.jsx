...
import singer from'../assets/styles/Artista.module.css'
export const Artista = ({pic, name,view}) => {
  return (
    <div className={singer.container}>
<img className={singer.profile} src={pic} alt="" />
<h3 className={singer.name}>{name}</h3>
<div className={singer.viewsContainer}>
<svg xmlns="http://www.w3.org/2000/svg" width="12" height="16" fill="currentColor" class="bi bi-ear" viewBox="0 0 16 16">
...
</svg><p className={singer.views}>{view}</p>
</div>
